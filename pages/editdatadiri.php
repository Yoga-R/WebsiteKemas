...
<div class="col-12">
		...
		?>
                                ...
                                <form action="aksi/aksi_editprofil.php" method="POST">
                                    <div class="form-group">
                                        <label for="name">Nama Lengkap</label>
                                        <input value=" <?= $id_session; ?>" type = "hidden" name= "iddonatur" hidden>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" value="" id="password" name="password" class="form-control" placeholder="Masukkan Password">
                                    </div>
                                    <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-outline-dark">Ubah Data Diri</button>
                                    </div>
                                </form>
